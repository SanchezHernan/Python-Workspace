...
class Dialogo(QDialog):
 ...
 def download(self):
  if self.btn_active == True:
   ...
   if not self.file.open(QIODevice.WriteOnly): 
    self.stateLabel.setText("No se pudo crear el archivo")
    self.file.close()
 ...
 def start_download(self):
  ...
  self.stateLabel.setText("Iniciando la descarga ...")
 ...
 def ready_read(self):
  ...
  self.stateLabel.setText("Descargando ...")
 ...
 def finished_download(self):
  ...
  if self.errorCode is not None:
   ...
   self.stateLabel.setText(str(self.errorCode) + ": " + self.errorString)
   #Eliminar el archivo
   self.file.remove()
  else: 
   self.stateLabel.setText("Descarga completada")
